  ...
  return (
    <div className="z-50 fixed w-full">
      ...
      <div
        ...
        } bg-indigo-700 transform  xl:translate-x-0 shadow xl:rounded-r fixed h-full  top-22 sm:z-50 z-50 hover:overflow-auto  ease-in-out transition duration-500 flex justify-start items-start w-full sm:w-64 flex-col px-0`}
      >
        ...
        <div className="w-full sm:px-5 px-10 sm:py-0 py-5">
          <div
            className="px-6 text-indigo-200  w-full bg-indigo-900 rounded-2xl py-2"
            id="avatar"
          >
            <div class="flex flex-col items-center mb-2 -mx-2">
              <img
                ...
                alt="avatar"
              />
              <h4 class="mx-2 mt-2 font-medium">{userInfo === null ? "ok" : userInfo.name}</h4>
              <p class="mx-2 mt-1 text-sm font-medium ">gegegge</p>
            </div>
          </div>
        </div>
        ...
        <div className="   mt-4 flex flex-col px-6 justify-start items-center w-full   ">
          ...
          <button className="focus:outline-none focus:text-white  flex jusitfy-start text-indigo-200 hover:text-white rounded py-3   items-center w-full  space-x-6">
            ...
            <p className="text-base leading-4 border-b border-transparent  hover:border-white focus:border-white ">
              <Link to="/dashboard/admin/all-order">Commande</Link>
            </p>
          </button>
          {/* User */}
          ...
          {/* Administration */}
          <button className="focus:outline-none focus:text-white  flex justify-start items-center space-x-6 bg-indigo-900 p-1 text-indigo-200 hover:text-white rounded-xl  py-3    w-full ">
            <svg
              width={24}
              height={24}
              viewBox="0 0 24 24"
            ...
            <p className="text-base text-start leading-4 border-b border-transparent  hover:border-white focus:border-white  ">
